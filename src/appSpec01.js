...
`,
    ...
    },
    {
      ...
      dataref: "qPub",
      colspecs: [
        { title: "Year", field: "year", cellStyle: { cellWidth: "10%" } },
        ...
        { title: "Authors", field: "authors", cellStyle: { cellWidth: "20%" } },
        {
          ...
          field: "pdf",
          render: (rowData) => (
            <a href={"https://lipyeow.github.io/home/" + rowData.pdf} download>
              pdf
            </a>
          ),
        },
    ...
    { type: "text", id: "txt2", value: "Projects" },
    {
      type: "tabcontainer",
      id: "tabcontainer01",
      tabs: [
        {
          label: "Education",
          idx: 0,
          widgets: [{ type: "text", id: "txt3", value: "Education!" }],
        },
        {
          label: "Publications",
          idx: 1,
          widgets: [{ type: "text", id: "txt3", value: "Pubs!" }],
        },
        {
          label: "Teaching",
          idx: 2,
          widgets: [{ type: "text", id: "txt4", value: "Teaching!" }],
        },
      ],
    },
    {
